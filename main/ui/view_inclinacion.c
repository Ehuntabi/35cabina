...
static void refresh_cb(lv_timer_t *t)
{
    ...
    char buf[48];
    snprintf(buf, sizeof(buf), "Cabeceo %+.1f\xC2\xB0  Balanceo %+.1f\xC2\xB0", pitch, roll);
...
void view_inclinacion_create(lv_obj_t *parent)
{
    ...
    lv_obj_align(s_circle, LV_ALIGN_CENTER, 0, -30);
    ...
    s_label_deg = lv_label_create(parent);
    lv_label_set_text(s_label_deg, "--");
    ...
    lv_obj_align_to(s_label_deg, s_circle, LV_ALIGN_OUT_BOTTOM_MID, 0, 14);
    ...
    lv_obj_align_to(s_label_status, s_label_deg, LV_ALIGN_OUT_BOTTOM_MID, 0, 6);
    ...
    lv_obj_align(calib_btn, LV_ALIGN_BOTTOM_MID, 0, -16);
